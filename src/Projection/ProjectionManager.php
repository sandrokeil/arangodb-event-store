...
use function Prooph\EventStore\ArangoDb\Fn\responseContentAsJson;
...
EOF;
    ...
    public function fetchProjectionStatus(string $name): ProjectionStatus
    {
        ...
        return ProjectionStatus::byValue(responseContentAsJson($response, 'status'));
    }
    ...
    public function fetchProjectionStreamPositions(string $name): array
    {
        ...
        return responseContentAsArray($response, 'position');
    }
    ...
    public function fetchProjectionState(string $name): array
    {
        ...
        return responseContentAsArray($response, 'state');
    }
}
