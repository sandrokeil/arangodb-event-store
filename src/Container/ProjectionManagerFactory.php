    ...
    RequiresMandatoryOptions
{
     ...
     * <?php
     * return [
     *     ProjectionManager::class => [ArangoDbProjectionManagerFactory::class, 'service_name'],
     * ];
     * </code>
     *
     * @throws InvalidArgumentException
     */
    public static function __callStatic(string $name, array $arguments): ProophProjectionManager
    {
    ...
    public function __invoke(ContainerInterface $container): ProophProjectionManager
    {
